...
def snap_three_zones(step_by_step=False):
    ...
    vc_hwnd, _ = ensure_window("Visual Studio Code", None, "primary", monitors)
    tb_hwnd, _ = ensure_window("Tabbit", None, "primary", monitors)
    fm_hwnd, _ = ensure_window("Explorer", None, "primary", monitors)
